...
RESULTS_FILE = "baseline_ar_evaluation.csv"
# generate a list of paths to the student models
MODEL_DIR = "/baseline-models/models"
...
curr_student_model = KnowledgeDistillationModels.get_vanilla_model_cifar100(100, X_train, sizes[0], )
