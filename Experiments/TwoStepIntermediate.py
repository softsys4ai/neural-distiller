...
def run(logger, options):
    logger.info(cfg.student_train_spacer + "TWO STEP STUDENT-TEACHER EXPERIMENT" + cfg.student_train_spacer)
    ...
    logger.info(cfg.student_train_spacer + "INTERMEDIATE STUDENT TRAINING SESSION STARTED" + cfg.student_train_spacer)
    ...
    logger.info(cfg.student_train_spacer + "STUDENT TRAINING SESSION" + cfg.student_train_spacer)
