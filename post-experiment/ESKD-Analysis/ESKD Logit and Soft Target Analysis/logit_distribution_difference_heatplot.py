...
fig.savefig("average-train-logit-difference.png")
plt.show()
...
fig = train_plot.get_figure()
fig.savefig("average-test-logit-difference.png")
plt.show()
...
fig = train_plot.get_figure()
fig.savefig("train-logit-difference.png")
plt.show()
...
fig.savefig("test-logit-difference.png")
plt.show()
