...
from rapid_proto import input_data as idata
...
def run_cnn():
    ...
    # todo: insert logic here to quantize network weights and perform
    ...
    writer = tf.summary.FileWriter('/Users/blakeedwards/PycharmProjects')
